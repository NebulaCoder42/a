...
<head>
    <meta charset="utf-8" />
    <title>Monaco Text Editor</title>
    <style type="text/css">
        :root {
        --editor-bg: #1C1C1C; /* Background color for the editor */
        --editor-line-numbers: #6c7086; /* Color for the numbers on the side */
        --editor-cursor: #ff4444;
        --editor-selection: rgba(255, 68, 68, 0.3); /* Red selection highlight */
        --editor-widget-bg: #161616; /* Suggestions/autocomplete background color */
        --editor-font: 'JetBrains Mono', 'Fira Code', Consolas, monospace;

        --accent-color: #ff4444; /* minimap toggle and other accents */
        --secondary-accent: #00ffcc; /* Bright teal for secondary accents (e.g., function names) */

        --keyword-color: #ff4444; /* Red for keywords like `function`, `return`, `end`, etc. */
        --local-keyword-color: #0095ff; /* Bright blue for local keywords */
        --comment-color: #079c11; /* Green for comments */
        --string-color: #00ff66; /* Bright green for strings */
        --number-color: #ff66cc; /*numbers */
        --function-color: #ff0101; /* function names */
        --variable-color: #00ffcc; /* variables */
        --operator-color: #ff66ff; /* operators */
        --line-highlight: #222222; /* highlighted line */
        --active-line-number: #ffcc00; /* active line number */
        --indent-guide: #44475a; /* Gray for indent guides */
        --active-indent-guide: #6272a4;
        --autocomplete-selected: #2d2f36; /* selected autocomplete */
        --tab-border: #ff0000; /* border for tabs */
        }
...
<body>
    ...
    <script type="text/javascript">
        ...
        var tabs = {
            "main": {
                content: "-- Welcome to Rankalf\n--Thanks For Using!\n\nlocal function greet(name)\n    return \"Your Name Is, \" .. name .. \"!\"\nend\n\nprint(greet(\"Omnomnom\"))",
                language: "lua"
            }
        };
        ...
        require(['vs/editor/editor.main'], function () {
           ...
           monaco.editor.defineTheme('dark-theme', {
            ...
            function createNewFile() {
                ...
                const fileName = `Tab-${Object.keys(tabs).length}`;
